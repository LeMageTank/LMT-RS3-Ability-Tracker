...
class MouseBindSelector:
    ...
    def popup(self,x,y):
        ...
        root.iconphoto(False,ImageTk.PhotoImage(file='app\\data\\app icons\\icon.png'))
...
class ProfileCreator:
    def __init__(self, icons_path, profile_path, profile_types, modifier_keys):
        ...
        self.clickable_region_path = 'app\\data\\saved profile clickables\\{}{}{}.png'

        self.root = tkinter.Tk()
        self.root.geometry('420x500')
        self.root.attributes('-topmost', True)
        self.root.iconphoto(False,ImageTk.PhotoImage(file='app\\data\\app icons\\icon.png'))
        ...
        self.mouse_ability_image = ImageTk.PhotoImage(Image.open('app\\icons\\Zaros Godsword.png'))
...
if __name__ == '__main__':
    profile_creator = ProfileCreator('app\\icons\\', 'app\\data\\saved profiles\\', profile_types, modifier_keys)
